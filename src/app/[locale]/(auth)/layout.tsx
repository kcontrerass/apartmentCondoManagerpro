    ...
    return (
        <div className="flex min-h-screen bg-white dark:bg-slate-950 font-sans">
            ...
            <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-900 border-r border-slate-200 dark:border-slate-800">
                ...
                <div className="absolute inset-0 bg-gradient-to-br from-indigo-900/90 via-slate-900/95 to-slate-950/90 z-10 mix-blend-multiply flex flex-col justify-between p-12">
                    <div className="z-20">
                        ...
                        <p className="text-indigo-200/80 text-lg max-w-sm leading-relaxed">
            ...
            {/* Right Box - Auth Form */}
            <div className="flex-1 flex flex-col justify-center items-center px-4 sm:px-6 lg:px-20 xl:px-24 bg-slate-50 dark:bg-slate-900 relative">
                {/* Mobile top band */}
                ...
                <div className="w-full max-w-sm pt-12 pb-12 mt-8 lg:mt-0">
                    <div className="mb-8 hidden lg:block text-center sm:text-left">
                        <h2 className="text-3xl font-extrabold text-slate-900 dark:text-white tracking-tight">
                            Bienvenido a <span className="text-indigo-600 dark:text-indigo-400">ADESSO</span>
                        </h2>
                    ...
                    <div className="bg-white dark:bg-slate-900/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] dark:shadow-[0_8px_30px_rgb(0,0,0,0.2)] rounded-2xl p-8 sm:p-10 border border-slate-100 dark:border-slate-800 backdrop-blur-xl transition-all duration-300">
                        {children}
                    </div>
                </div>
            </div>
