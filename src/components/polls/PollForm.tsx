    ...
    return (
        <form onSubmit={handleSubmit} className="space-y-6">
            <div className="space-y-4">
                <div>
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-widest block mb-2">Título de la Votación</label>
                    <input
                        required
                        value={title}
                ...
                <div>
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-widest block mb-2">Descripción (Opcional)</label>
                    <textarea
                        value={description}
                ...
                <div>
                    <div className="flex justify-between items-center mb-4">
                        <label className="text-xs font-bold text-slate-400 uppercase tracking-widest">Opciones de Respuesta</label>
                        {options.length < 6 && (
                            <button
                                type="button"
                ...
                <div>
                    <label className="text-xs font-bold text-slate-400 uppercase tracking-widest block mb-2">Fecha de Cierre (Opcional)</label>
                    <input
                        type="date"
                        value={expiresAt}
