...
const EventCard: React.FC<EventCardProps> = ({ event }) => {
    ...
    return (
        <Link
            ...
            className="block group bg-white dark:bg-background-dark rounded-[2rem] border border-slate-100 dark:border-slate-800 shadow-xl shadow-slate-200/50 dark:shadow-none hover:shadow-2xl hover:-translate-y-2 transition-all duration-500 overflow-hidden"
        >
            {event.imageUrl ? (
            ...
            <div className="p-7">
                <div className="mb-4 flex flex-wrap gap-2">
                    ...
                    {event.complex && (
                        <span className="text-[10px] font-black text-slate-600 bg-slate-100 dark:bg-background-dark dark:text-slate-300 px-3 py-1.5 rounded-full tracking-widest uppercase border border-slate-200 dark:border-slate-700 flex items-center gap-1">
                ...
                <div className="space-y-4">
                    <div className="flex items-center text-sm text-slate-500 dark:text-slate-400 font-medium">
                        <div className="w-8 h-8 rounded-lg bg-slate-50 dark:bg-background-dark flex items-center justify-center mr-3 group-hover:bg-primary/10 group-hover:text-primary transition-colors">
